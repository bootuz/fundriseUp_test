...
export class DonationWindow extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.continueButton = new Button(
            donationWidget.locator('[data-qa="card-continue"]')
        )
        this.coverFeeButton = new Button(
            donationWidget.locator('[data-qa="cover-fee-checkbox"]')
        )
        this.currencySelector = new Select(
            donationWidget.locator('[data-qa="currency-selector"]')
        )
        this.creditCardButton = new Button(
            donationWidget.locator('[data-qa="cc-button"]')
        )
        this.giveMonthlyButton = new Button(
            donationWidget.locator('[data-qa="give-monthly"]')
        )
        this.donetaAmountButton = new Button(
            donationWidget.locator('[data-qa="privacy-continue"]')
        )
        this.expirationDateInput = new Input(
            donationWidget
        ...
        this.emailInput = new Input(
            donationWidget.locator('[data-qa="personal-email"]')
        )
        this.amountInput = new Input(
            donationWidget.locator('[data-qa="amount"]')
        )
        this.lastNameInput = new Input(
            donationWidget.locator('[data-qa="personal-last-name"]')
        )
        this.firstNameInput = new Input(
            donationWidget.locator('[data-qa="personal-first-name"]')
        )
        this.creditCardNumberInput = new Input(
            donationWidget
